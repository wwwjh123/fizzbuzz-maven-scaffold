...
public  static Area area;
   ...
   public  void test_Rover_TurnLeft_S() {
    ...
    public void test_Rover_TurnLeft_S_not_init_point() {
    ...
    @Test
    @DisplayName("北 -> 批量左转")
    public void test_batch_TurnLeft_S() {
    ...
    public void test_batch_Move_and_Turn_S() {
    ...
    public  void test_batch_Move_and_Turn_E() {
    ...
    public void test_batch_Move_and_Turn_more() {
